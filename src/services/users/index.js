...
usersRouter.post(
  ...
  [
    ...
    check("street").isLength({ min: 5 }).withMessage("Invalid Street Adress").exists().withMessage("Add Street Adress please!"),
    check("city").exists().withMessage("Add City please!"),
    check("postalCode").exists().withMessage("Add Postal Code please!"),
    check("expDate").exists().withMessage("Add Exp. Date please!"),
